...
<p>You need to select a <span data-keyword="subset" class=" cursor-pointer relative text-dark-blue-s text-sm"><button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-_r_1v_" data-state="closed" class="">subset</button></span> of <code>nums</code> which satisfies the following condition:</p>
